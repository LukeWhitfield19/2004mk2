<template>
  ...
  <div id="choose">
      <p>Q1. What's the image colour type><br>
        ...
        <input type="radio" id="3" v-model="Q1" style="left:140px;" value="Full Colour"><label for="3" style="left:150px;">Colour</label>
      </p>
      <br>

      <p>Q2. Is the colour in the image aesthetical, or is it used for data visualisation<br>
      ...
      <p>Q3. Is there a colour mapping legend<br>
      ...
      <p>Q4. How many colours are in the image><br>
      ...
      <p>Q5. Is the colour mapping categorical or continuous?<br>
      ...
      <p>Q6. How difficult did you find it to label this image? (1=easy 5 =impossible)<br>
